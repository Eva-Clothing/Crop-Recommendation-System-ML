...
def predict():                                      #defining prediction function
    ...
    file = pd.read_csv("/home/rashi/Downloads/Hackbattle20--main/Cat_Crop.csv")                          #reading csv file into dataframe
    ...
    with open("input.json","w") as sout:
        sout.write(output)
    filename = "/home/rashi/Downloads/Hackbattle20--main/CRSML.sav"
    loaded_model = joblib.load(filename)
    
    file_path = "/home/rashi/Downloads/Hackbattle20--main/input.json"
    ...
    jsonFilePath = "/home/rashi/Downloads/Hackbattle20--main/Prediction.json"                            #Extracting information related to predicted crop            
